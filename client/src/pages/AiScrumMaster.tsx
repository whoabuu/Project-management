...
const MOCK_MESSAGES: Message[] = [
  ...
  {
    id: 'm3', role: 'ai', type: 'thinking',
    timestamp: '09:02 AM',
    content: 'Analysing epic scope, tech stack, and team capacity…',
  },
  {
  ...
  {
    id: 'm6', role: 'user', type: 'text',
    timestamp: '09:05 AM',
    content: `This looks great. Can you assign the "JWT token signing" task to Sara instead? She mentioned she wants more backend experience.`,
  },
  {
    id: 'm7', role: 'ai', type: 'text',
    timestamp: '09:05 AM',
    content: `Done! I've reassigned **"Build JWT access + refresh token signing service"** to Sara R.\n\nUpdated capacity:\n• **Abu Bakar** — now at 24h load (4h freed up)\n• **Sara R.** — now at 29h load (3h added)\n\nSara is still within sprint capacity. I've also noted in the task rationale that this is a deliberate skill-building assignment. Is there anything else you'd like to adjust before I save these to the backlog?`,
  },
];
...
const TaskWidget = ({ widget }: { widget: TaskWidget }) => {
  ...
  return (
    ...
    ">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[11px] text-white/70">
              {widget.epicId} · {widget.epicTitle}
            </p>
          </div>
        </div>
      ...
      {/* Stats bar */}
      <div className="
        grid grid-cols-3 divide-x divide-slate-100 dark:divide-slate-800
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-1.5 mt-1.5 flex-wrap">
                  {/* Type */}
                  <span className={`px-1.5 py-0.5 rounded-md text-[10px] font-semibold ${t.color}`}>
                    {t.label}
                  </span>
                  {/* Priority */}
...
const ThinkingBubble = ({ content }: { content: string }) => (
  <div className="flex items-start gap-3">
    ...
    ">
      ...
      <span className="text-[12.5px] italic text-slate-500 dark:text-slate-400">
        {content}
      </span>
    </div>
  </div>
  ...
  if (isUser) {
    return (
      <div className="flex items-end justify-end gap-2.5">
        ...
        <div className="
          flex items-center justify-center
          w-8 h-8 rounded-xl shrink-0 mb-5
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      const aiMsg: Message = {
        ...
        role:      'ai',
        type:      'text',
        content:   `I've received your message: "*${trimmed}*"\n\nThis is a mock response — the live Groq LLM integration will be connected in the next sprint. For now, I'm running in demo mode.`,
  ...
  return (
    <div className="flex flex-col h-full max-h-[calc(100vh-112px)] -m-6">
      ...
      >
        ...
        {isTyping && (
          <ThinkingBubble content="Thinking…" />
        )}
      </div>

      {/* ── Suggested prompts ─────────────────────────────── */}
      <div className="
        flex items-center gap-2 px-6 py-2 shrink-0
        overflow-x-auto
        bg-white dark:bg-slate-950
      ...
      ">
        ...
        ">
          ...
          <button
            ...
            className="
              flex items-center justify-center
              w-8 h-8 rounded-xl shrink-0 mb-0.5
          ...
          <textarea
            ...
            className="
              ...
              text-[13.5px] text-slate-800 dark:text-slate-200
          ...
          <button
            ...
            className="
              ...
              transition-all duration-150
              shadow-sm shadow-sky-500/30 disabled:shadow-none
            "
          >
            <Send size={14} />
          </button>
